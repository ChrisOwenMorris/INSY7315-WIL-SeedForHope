...
class OrderView : Fragment(R.layout.screen_order_view) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.btn_back).setOnClickListener {
            findNavController().navigate(R.id.action_orderView_to_orderBook)
        }

        val orderRef = requireArguments().getString("orderRef")
        ...
        view.findViewById<TextView>(R.id.tv_customer_name).text = order.customer
        view.findViewById<TextView>(R.id.tv_customer_email).text = order.email
        view.findViewById<TextView>(R.id.tv_customer_phone).text = order.phone
        ...
        view.findViewById<TextView>(R.id.tv_subtotal).text = rand + subtotal
        ...
        view.findViewById<TextView>(R.id.tv_total).text = rand + order.total
    }
    ...
    private fun bindTracker(view: View, status: String) {
        ...
        for (i in 0..3) {
            ...
            label.setTextColor(
                ContextCompat.getColor(
                    requireContext(),
                    if (filled) R.color.ink else R.color.ink_muted
                )
            )
        }
        ...
        for (i in 0..2) {
            ...
            view.findViewById<View>(lineIds[i]).setBackgroundColor(
                ContextCompat.getColor(
                    requireContext(),
                    if (completed) R.color.forest_500 else R.color.line
                )
            )
        }
    }
