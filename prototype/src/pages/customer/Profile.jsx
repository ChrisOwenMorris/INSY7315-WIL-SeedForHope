    ...
    <div className="max-w-[700px] mx-auto px-6 py-12">
      ...
      >
        ...
        <div>
          ...
          <input id="name" className={inputClasses} defaultValue={currentUser.name} />
        </div>
        <div>
          <label htmlFor="email" className={labelClasses}>Email address</label>
          <input id="email" type="email" className={inputClasses} defaultValue={currentUser.email} />
        </div>
        <div>
          <label htmlFor="phone" className={labelClasses}>Phone number</label>
          <input id="phone" className={inputClasses} defaultValue={currentUser.phone} />
        </div>
