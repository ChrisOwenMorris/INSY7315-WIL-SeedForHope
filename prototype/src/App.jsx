...
import ResetLinkSent from './pages/public/ResetLinkSent.jsx'
import MyOrders from './pages/public/MyOrders.jsx'
import MyOrderDetail from './pages/public/MyOrderDetail.jsx'
      ...
      <CartProvider>
        <Routes>
          ...
          <Route element={<PublicLayout />}>
            ...
            <Route path="/order-confirmed/:ref" element={<OrderConfirmation />} />
            <Route path="/login" element={<Login />} />
            <Route path="/register" element={<Register />} />
            <Route path="/forgot-password" element={<ForgotPassword />} />
            <Route path="/reset-link-sent" element={<ResetLinkSent />} />
            <Route path="/my-orders" element={<MyOrders />} />
            <Route path="/my-orders/:ref" element={<MyOrderDetail />} />
